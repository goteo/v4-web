<script lang="ts">
    ...
    let hasMedia = $derived(Boolean(hero?.mediaUrl));
        ...
        <div class="container mx-auto py-16 lg:py-24">
            <Grid
                class={[
                    ...
                    hasMedia ? "lg:grid-cols-2" : "lg:grid-cols-3",
                ]}
            >
                <!-- Hero Content -->
                <div class={["space-y-8", !hasMedia && "lg:col-span-2"]}>
                    <h1
                        class="text-secondary text-4xl leading-tight font-bold lg:text-5xl xl:text-6xl"
                    >
                        {hero.title}
                    </h1>
